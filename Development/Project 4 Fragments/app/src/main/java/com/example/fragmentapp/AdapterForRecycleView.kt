...
class AdapterForRecycleView(private val items: ArrayList<String>) : RecyclerView.Adapter<MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        // Below layoutInflater is used to bind the XML to a single view.
        val demo = LayoutInflater.from(parent.context).inflate(R.layout.itemforrecycleview , parent , false)
